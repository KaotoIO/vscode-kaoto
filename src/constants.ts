...
// ─── Infrastructure Settings IDs ─────────────────────────────────────────────

export const KAOTO_CAMEL_JBANG_INFRA_ARGUMENTS_SETTING_ID = 'kaoto.camelJbang.infraArguments';
...
// ─── Infrastructure Context Keys ─────────────────────────────────────────────

export const CONTEXT_INFRASTRUCTURE_CATALOG_LOADED = 'kaoto.infrastructureCatalogLoaded';

export const CONTEXT_INFRASTRUCTURE_RUNNING = 'kaoto.infrastructureRunning';

export const CONTEXT_INFRASTRUCTURE_STARTING = 'kaoto.infrastructureStarting';

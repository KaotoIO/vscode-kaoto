...
- [Kaoto UI](https://github.com/KaotoIO/kaoto-ui) in version [1.1.0-M3](https://github.com/KaotoIO/kaoto-ui/releases/tag/v1.1.0-M3).
- [Kaoto Backend](https://github.com/KaotoIO/kaoto-backend) in version [1.1.0-M2](https://github.com/KaotoIO/kaoto-backend/releases/tag/v1.1.0-M2).

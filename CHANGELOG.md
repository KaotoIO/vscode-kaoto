...
- Upgrade embedded Kaoto [UI](https://github.com/KaotoIO/kaoto-ui/releases/tag/v0.7.4) to 0.7.4 and [backend](https://github.com/KaotoIO/kaoto-backend/releases/tag/v0.7.4) to 0.7.4

...
- Upgrade embedded Kaoto [UI](https://github.com/KaotoIO/kaoto-ui/releases/tag/v1.1.0-M3) to 1.1.0-M3 and [backend](https://github.com/KaotoIO/kaoto-backend/releases/tag/v1.1.0-M2) to 1.1.0-M2

...
import { CATALOG_VERSION_ID, readUserSetting } from '../Util';

describe('Camel version', function () {
	this.timeout(15000);

	const testDescription = process.env.CAMEL_JBANG_SNAPSHOT_VERSION
		? `Check actual version is ${process.env.CAMEL_JBANG_SNAPSHOT_VERSION}`
		: 'Nothing to check';

...
import fs from 'fs';
import { ActivityBar, after, afterEach, before, beforeEach, By, EditorView, InputBox, SideBarView, TreeItem, until, ViewControl, ViewPanelActionDropdown, ViewSection, VSBrowser, WebDriver, WebElement } from "vscode-extension-tester";
...
describe('Integrations View', function () {
    ...
    (process.platform === 'darwin' ? describe.skip : describe)(`Click 'New File...' button`, function () {
        ...
        async function getNewFileTreeItem(filename: string): Promise<TreeItem> {
            ...
            }, 120_000, `${filename} was not created properly within Integrations view!`);
        }
        ...
        async function switchToKaotoAndCheckIntegrationType(filename: string, type: string): Promise<void> {
            ...
            }, 30_000, `Kaoto editor for a new ${type} file was not opened!`);
